...
% Solution cachée pour les professeurs
\ifteacher
\begin{solution}
Les paires de droites sont :
\begin{itemize}
\item \trans{perpendicular} : c, e, h
\item \trans{parallel} : a, d, f
\item \trans{secant} : b, g, i
\end{itemize}
\end{solution}
\fi